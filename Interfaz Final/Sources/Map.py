...
class MapHeat():
    def __init__(self):
        self.munon = pv.read("MallaSTL-sept1.stl")
        ...
        self.plotterBackground = pvqt.BackgroundPlotter(show=False)
...
munon.SetZone1(100)
munon.PrintZone1()
munon.change_neighbors(1211, 33, 200)
munon.change_neighbors(1096, 33, 200)
munon.change_neighbors(1256, 33, 300)
munon.change_neighbors(1148, 33, 400)
'''munon.change_neighbors(6077, 50, 1500)
munon.change_neighbors(6909, 30, 4000)
munon.change_neighbors(5597, 15, 4000)
munon.change_neighbors(6554, 100, 5000)'''
munon.AddMesh()
munon.AddScalarBar()
munon.ShowPlotter()